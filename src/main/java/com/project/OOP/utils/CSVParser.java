...
/**
 * Classe che fornisce gli strumenti per parsare il file CSV già scaricato
 */
public class CSVParser {
     ...
     * @throws IOException Eccezione che verrà lanciata in caso di problemi durante l'operazione di Input/Output
     */
